...
@Metadata {
  @PageKind(article)
  @PageColor(purple)
  @TitleHeading("Archive")
  @PageImage(purpose: icon, source: "blog-blog-icon", alt: "Blog Icon")
  @PageImage(purpose: card, source: "blog-blog-card", alt: "Blog Card")
}
...
@Image(source: "blog-blog-hero", alt: "Blog Hero")
