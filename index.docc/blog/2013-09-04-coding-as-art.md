...
@Metadata {
  ...
  @PageImage(purpose: card, source: "blog-2013-09-04-coding-as-art-card", alt: "Coding as Art card")
  @PageKind(article)
  @PageColor(blue)
}
...
Acting taught me empathy and scene work that map directly to software development.
...
I came to this realization after I applied for a

[Flatiron School Fellowship](http://flatironschool.com/)

position to gain more Ruby on Rails experience. Until now, wrkstrm has a completely native Objective C codebase. There is no intermediary PhoneGap or Xamarin type of framework which uses Javascript or C# in my projects. I chose not to use those frameworks for aesthetic and moral reasons rather than the simple fact they help ship apps. After all, I am not a paid developer. When coding, I optimize fun or enjoyment rather that practically. During the application process, one question struck me as odd:
...
I submitted a response which elaborated on my experience on the [Student Managed Investment Fund at Bucknell University](http://video.cnbc.com/gallery/?video=3000015199). However, at first, I wrote out a completely different response which I would like to share in elongated form.
